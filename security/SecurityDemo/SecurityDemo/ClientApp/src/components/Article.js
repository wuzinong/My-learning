  ...
  return (
    <Container>
      <Box fontSize={24} textAlign='center' mt={2}>
        Introduction to test Data Fabric
      </Box>
      <Grid container spacing={2} mt={3}>
        <Grid item xs={6}>
          ...
          <Box p={2}>
            test Data Fabric is a secure data management space for cloud and
        ...
        <Grid item xs={6} mt={2}>
          ...
          <Box p={2}>
            <p>We offer three data management roles within test Data Fabric.</p>
            <p>
        ...
        <Grid item xs={6}>
          ...
          <Box p={2}>
            Data managers on test have secure access to an eco-system of data
            providers and a wide variety of analytics technologies, available
            from the test Marketplace. It allows you to securely share data for
            advanced analytics with tools like Arundo Fabric, Azure Databricks,
            Azure HDInsight, Azure Machine Learning Studio and others.
          </Box>
        </Grid>
        <Grid item xs={6}>
          <img
